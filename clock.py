...
class Clock():
    ...
    def getweekday(self, today):
        return ['Mon', 'Tue', 'Wed', 'Thurs', 'Fri', 'Sat', 'Sun'][today.weekday()]
    ...
    def starttick(self, second_hand, minute_hand, hour_hand, printer):
        ...
        turtle.tracer(False)
        printer.forward(65)
        printer.write(self.getweekday(today), align='center', font=("Times", 15, "bold italic"))
        printer.forward(120)
        printer.write('12', align='center', font=("Times", 15, "bold italic"))
        printer.back(250)
        printer.write(self.getdate(today), align='center', font=("Times", 15, "bold italic"))
        printer.back(145)
        printer.write('6', align='center', font=("Times", 15, "bold italic"))
        printer.home()
        printer.right(92.5)
        printer.forward(200)
        printer.write('3', align='center', font=("Times", 15, "bold italic"))
        printer.left(2.5)
        printer.back(400)
        printer.write('9', align='center', font=("Times", 15, "bold italic"))
        printer.home()
        turtle.tracer(True)
